async function loadTransactionData() {
    ...
    try{
        ...
        document.getElementById('total-earnings-monthly').textContent = price.earnings;
    ...
    try{
        ...
        document.getElementById('total-earnings-yearly').textContent = price.earnings;
    ...
    try{
        ...
        console.log(response)
        document.getElementById('total-pending-verifications').textContent = count.count;
